...
обновление индекса после мутаций). Формат — как в `PLAN-2026-09-17-done-webui.md`
/ `PLAN-2026-09-19-done-lsp.md`: статус, решения, привязка к текущему коду, этапы с чекбоксами,
...
| `docs/PLAN-2026-09-19-done-qdrant.md` | этот план |
