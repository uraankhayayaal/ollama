...
недостижим из Web UI — см. `PLAN-2026-09-25-done-e2e-findings.md`).
...
- [ ] Ручной E2E на реальном проекте (2026-09-25, Web UI + CLI, `e2e-makefile-app`,
      ...
      недостижим из Web UI (см. новый план `PLAN-2026-09-25-done-e2e-findings.md`).
...
- `PLAN-2026-09-19-done-epic-task-token.md` — прогноз/факт токенов по эпикам: правила ролей
