...
Статус: **ПЛАН (реализация позже)**. Источник — прежний `PLAN-2026-09-19-todo-epic-task-token.md`
...
Формат — как в `PLAN-2026-09-17-wip-webui.md` / `PLAN-2026-09-19-done-lsp.md`: статус, решения, привязка к
...
| `docs/PLAN-2026-09-19-todo-epic-task-token.md` | этот план |
