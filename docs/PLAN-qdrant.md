...
(планировщик: подмешивание контекста RAG); далее Ф-5 — авто-обновление
индекса. Формат — как в `PLAN-webui.md`
...
### Идеи для продоожения

1. Добавить прогресс индексации в UI