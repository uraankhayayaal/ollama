...
Формат — как в `PLAN-2026-09-17-done-webui.md` / `PLAN-2026-09-19-done-lsp.md`.
Дополняет уже выполненный `PLAN-2026-09-20-done-dashboard-workflow.md` (Ф-1..Ф-5: ветки эпиков/задач,
...
3. Порядок зависит от `PLAN-2026-09-22-done-dashboard-chat-create.md` (создание через чат) — там
