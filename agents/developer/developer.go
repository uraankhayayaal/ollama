...
5. После каждого набора изменений проверяй, что проект компилируется и проходит проверки: запускай подходящие команды через Run (для Go — "go build ./...", "go vet ./...", при наличии тестов "go test ./..."; для других стеков — их аналоги).
